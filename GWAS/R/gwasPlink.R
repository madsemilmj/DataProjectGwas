...
gwasPlink <- function(total_indiv, SNP, h, k){
  ...
  makegwas1<- paste("plink --bfile", bfile, "--pheno", phenotype_GWAX_0, "--pheno-name Pheno --out", GWAX_0, "--linear --1")
  makegwas2<- paste("plink --bfile", bfile, "--pheno", phenotype_GWAX_1, "--pheno-name Pheno --out", GWAX_1, "--linear --1")
  ...
  makegwas5<- paste("plink --bfile", bfile, "--pheno", phenotype, "--pheno-name Pheno --out", case_ctrl, "--linear --1")
