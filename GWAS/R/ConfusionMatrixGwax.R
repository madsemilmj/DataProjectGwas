#' ConfusionMatrixGwax
#'
#' This function plots confusion matrix for the GWAX method
...
#' @importFrom dplyr %>%
#' @examples
#' ConfusionMatrixGwax(total_indiv = 1000, SNP = 1000, h = 0.5, sib =1, BFC = 1)
ConfusionMatrixGwax <- function(total_indiv, SNP, h, sib, BFC){
  ...
  if (file.exists(assoc_string)){
    ...
    print("No data exists for this ConfusionMatrixGwax! - Try another predefined or run our simulation")
  }
}
